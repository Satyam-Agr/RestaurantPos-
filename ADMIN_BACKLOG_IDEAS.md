...
These came up while designing the admin console but were deliberately left out of that build. Nothing here has any code behind it yet — just a record of the idea and roughly what it'd take, for whenever it's worth doing.
